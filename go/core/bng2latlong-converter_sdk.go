...
type Bng2latlongConverterSDK struct {
	Mode     string
...
func (sdk *Bng2latlongConverterSDK) OptionsMap() map[string]any {
...
func (sdk *Bng2latlongConverterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Bng2latlongConverterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Bng2latlongConverterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Bng2latlongConverterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Bng2latlongConverterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Bng2latlongConverterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Bng2latlongConverterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Bng2latlongConverterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Bng2latlongConverterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Bng2latlongConverterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *Bng2latlongConverterSDK {
	...
	sdk := NewBng2latlongConverterSDK(sdkopts)
	sdk.Mode = "test"
