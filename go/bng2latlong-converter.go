...
// instead of `sdk.NewBng2latlongConverterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *Bng2latlongConverterSDK  { return NewBng2latlongConverterSDK(nil) }
func Test() *Bng2latlongConverterSDK { return TestSDK(nil, nil) }
