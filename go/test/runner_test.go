...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("BNG2LATLONGCONVERTER_TEST_LIVE") == "TRUE" ||
		os.Getenv("BNG2LATLONGCONVERTER_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("BNG2LATLONGCONVERTER_TEST_EXPLAIN"); explain != "" {
