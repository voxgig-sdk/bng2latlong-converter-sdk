...
func registerSDKWords(r *eng.Registry, client *sdk.Bng2latlongConverterSDK) {
...
func runOp(client *sdk.Bng2latlongConverterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
