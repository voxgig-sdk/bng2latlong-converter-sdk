...
AQL-driven command-line client **and** interactive REPL for the Bng2latlongConverter
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `coordinate_conversion`).
