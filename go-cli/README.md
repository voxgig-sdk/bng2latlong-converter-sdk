...
AQL-driven CLI and REPL for the Bng2latlongConverter SDK. Positional arguments are
...
```sh
go build -o bng2latlong-converter-cli ./...
```
...
./bng2latlong-converter-cli list coordinate_conversion
./bng2latlong-converter-cli load 1 coordinate_conversion
./bng2latlong-converter-cli load '{id:1}' coordinate_conversion
