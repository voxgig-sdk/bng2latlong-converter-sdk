...
class CoordinateConversionEntity extends Bng2latlongConverterEntityBase<CoordinateConversion> {
  ...
  make(this: CoordinateConversionEntity) {
    return new CoordinateConversionEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CoordinateConversionLoadMatch, ctrl?: Control): Promise<CoordinateConversionEntity> {
