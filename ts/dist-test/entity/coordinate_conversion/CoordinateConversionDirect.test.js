...
(0, node_test_1.describe)('CoordinateConversionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.Bng2latlongConverterSDK({
    ...
    (0, node_test_1.test)('direct-load-coordinate_conversion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-coordinate_conversion', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BNG2LATLONG_CONVERTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.Bng2latlongConverterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BNG2LATLONG_CONVERTER_TEST_COORDINATE_CONVERSION_ENTID'];
    ...
    const client = new __1.Bng2latlongConverterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CoordinateConversionDirect.test.js.map