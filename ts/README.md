# Bng2latlongConverter TypeScript SDK



The TypeScript SDK for the Bng2latlongConverter API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.CoordinateConversion()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `Bng2latlongConverterSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `Bng2latlongConverterSDK.test(testopts?, sdkopts?)` | `Bng2latlongConverterSDK` | Create a test-mode client. |
...
├── src/
│   ├── Bng2latlongConverterSDK.ts        # Main SDK class
