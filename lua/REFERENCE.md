# Bng2latlongConverter Lua SDK Reference

Complete API reference for the Bng2latlongConverter Lua SDK.
...
```lua
local result, err = client:CoordinateConversion(nil):load({ id = "coordinate_conversion_id" }, nil)
```
