...
local CoordinateConversionEntity = {}
CoordinateConversionEntity.__index = CoordinateConversionEntity


function CoordinateConversionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CoordinateConversionEntity)
  self._name = "coordinate_conversion"
  self._client = client
...
function CoordinateConversionEntity:get_name()
  return self._name
end


function CoordinateConversionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CoordinateConversionEntity.new(self._client, opts)
end
...
function CoordinateConversionEntity:mark_deleted()
  self._deleted = true
end


function CoordinateConversionEntity:deleted()
  return true == self._deleted
end


function CoordinateConversionEntity:data_set(args)
  if args ~= nil then
...
function CoordinateConversionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CoordinateConversionEntity:match_set(args)
  if args ~= nil then
...
function CoordinateConversionEntity:match_get()
...
function CoordinateConversionEntity:stream(action, args, callopts)
...
function CoordinateConversionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CoordinateConversionEntity
