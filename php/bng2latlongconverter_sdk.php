...
class Bng2latlongConverterSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = Bng2latlongConverterHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = Bng2latlongConverterHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!Bng2latlongConverterFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, Bng2latlongConverterFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return Bng2latlongConverterUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = Bng2latlongConverterHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = Bng2latlongConverterHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = Bng2latlongConverterHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new Bng2latlongConverterError($op . "_allow",
                "Bng2latlongConverterSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = Bng2latlongConverterHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new Bng2latlongConverterError("graphql_error",
                "Bng2latlongConverterSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function CoordinateConversion($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_coordinate_conversion === null) {
                $this->_coordinate_conversion = new CoordinateConversionEntity($this, null);
            }
            return $this->_coordinate_conversion;
        }
        return new CoordinateConversionEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new Bng2latlongConverterSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
