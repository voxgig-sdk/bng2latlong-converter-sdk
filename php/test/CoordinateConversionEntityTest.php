...
class CoordinateConversionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        $coordinate_conversion_ref01_data_dt0_load_result = Helpers::to_map(is_object($coordinate_conversion_ref01_data_dt0_loaded) && method_exists($coordinate_conversion_ref01_data_dt0_loaded, 'data_get') ? $coordinate_conversion_ref01_data_dt0_loaded->data_get() : $coordinate_conversion_ref01_data_dt0_loaded);
        $this->assertNotNull($coordinate_conversion_ref01_data_dt0_load_result);
        $this->assertEquals($coordinate_conversion_ref01_data_dt0_load_result["id"], $coordinate_conversion_ref01_data["id"]);
