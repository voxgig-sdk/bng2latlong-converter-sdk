...
class Bng2latlongConverterTestRunner
{
    ...
    {
        $live = self::getenv('BNG2LATLONGCONVERTER_TEST_LIVE');
        $override = self::getenv('BNG2LATLONGCONVERTER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BNG2LATLONGCONVERTER_TEST_EXPLAIN');
