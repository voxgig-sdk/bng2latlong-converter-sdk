...
// Bng2latlongConverter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Bng2latlongConverterSDK::test)
...
{
    private const SDK_CLASS = 'Bng2latlongConverterSDK';
    ...
    private const SDK_BASE = 'bng2latlongconverter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bng2latlongconverter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
