...
// Bng2latlongConverter SDK streaming feature
...
class Bng2latlongConverterStreamingFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _iterate(Bng2latlongConverterResult $result): \Generator
    {
    ...
    private function _streamable(Bng2latlongConverterContext $ctx): bool
    {
