...
// Bng2latlongConverter SDK netsim feature
...
class Bng2latlongConverterNetsimFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _simulate(Bng2latlongConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Bng2latlongConverterContext $ctx, array $applied): void
    {
        $client = $this->client;
