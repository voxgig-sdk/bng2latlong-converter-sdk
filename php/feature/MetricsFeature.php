...
// Bng2latlongConverter SDK metrics feature
...
class Bng2latlongConverterMetricsFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _record(Bng2latlongConverterContext $ctx, bool $ok): void
    {
