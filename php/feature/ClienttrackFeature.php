...
// Bng2latlongConverter SDK clienttrack feature
...
class Bng2latlongConverterClienttrackFeature extends Bng2latlongConverterBaseFeature
{
    ...
    public function PostConstruct(Bng2latlongConverterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Bng2latlongConverter-SDK';
