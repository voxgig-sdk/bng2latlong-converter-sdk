...
// Bng2latlongConverter SDK telemetry feature
...
class Bng2latlongConverterTelemetryFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _close(Bng2latlongConverterContext $ctx, bool $ok): void
    {
