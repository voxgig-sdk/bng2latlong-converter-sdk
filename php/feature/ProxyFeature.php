...
// Bng2latlongConverter SDK proxy feature
...
class Bng2latlongConverterProxyFeature extends Bng2latlongConverterBaseFeature
{
    ...
    public function init(Bng2latlongConverterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Bng2latlongConverterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
