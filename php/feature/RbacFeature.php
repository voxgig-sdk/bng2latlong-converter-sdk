...
// Bng2latlongConverter SDK rbac feature
...
class Bng2latlongConverterRbacFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _required(Bng2latlongConverterContext $ctx): ?string
    {
    ...
    private function _reject(Bng2latlongConverterContext $ctx, string $required): void
    {
    ...
    private function _track(Bng2latlongConverterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
