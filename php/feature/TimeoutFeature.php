...
// Bng2latlongConverter SDK timeout feature
...
class Bng2latlongConverterTimeoutFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _with_timeout(Bng2latlongConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Bng2latlongConverterContext $_ctx, float $ms): void
    {
        $client = $this->client;
