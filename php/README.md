# Bng2latlongConverter PHP SDK



The PHP SDK for the Bng2latlongConverter API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($coordinateconversion->data_get());
} catch (\Throwable $err) {
...
```
php/
├── bng2latlongconverter_sdk.php          -- Main SDK class
...
The main class (`bng2latlongconverter_sdk.php`) exports the SDK class
