...
// Bng2latlongConverter SDK utility: make_options

class Bng2latlongConverterMakeOptions
{
    ...
    public static function call(Bng2latlongConverterContext $ctx): array
    {
        ...
        //
        // `Bng2latlongConverterSchema::optspec()` is built from the model:
        ...
        $optspec = Bng2latlongConverterSchema::optspec();
