...
// Bng2latlongConverter SDK utility: result_basic

class Bng2latlongConverterResultBasic
{
    public static function call(Bng2latlongConverterContext $ctx): ?Bng2latlongConverterResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof Bng2latlongConverterError) ? $result->err->msg : (string)$result->err;
