...
// Bng2latlongConverter SDK utility: fetcher

class Bng2latlongConverterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Bng2latlongConverterSDK/1.0)';
    ...
    public static function call(Bng2latlongConverterContext $ctx, string $fullurl, array $fetchdef): array
    {
