...
// Bng2latlongConverter SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Bng2latlongConverterMakeRequest
{
    public static function call(Bng2latlongConverterContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Bng2latlongConverterResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Bng2latlongConverterResponse($fetched);
        } else {
