...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.Bng2latlongConverterSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.Bng2latlongConverterSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
