...
// Bng2latlongConverter SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Bng2latlongConverterParam
{
    public static function call(Bng2latlongConverterContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Bng2latlongConverterHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
