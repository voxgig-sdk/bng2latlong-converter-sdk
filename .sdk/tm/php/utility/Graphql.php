...
// Bng2latlongConverter SDK utility: graphql
//
...
class Bng2latlongConverterGraphql
{
    ...
    // equivalent.
    public static function body(Bng2latlongConverterContext $ctx): mixed
    {
    ...
    public static function errors(Bng2latlongConverterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
