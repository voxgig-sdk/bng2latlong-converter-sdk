...
// Bng2latlongConverter SDK pipeline test
//
...
{
    private static function utility(): Bng2latlongConverterUtility
    {
        return new Bng2latlongConverterUtility();
    }
    ...
    private static function ctx(array $over = []): Bng2latlongConverterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Bng2latlongConverterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Bng2latlongConverterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Bng2latlongConverterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Bng2latlongConverterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Bng2latlongConverterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Bng2latlongConverterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Bng2latlongConverterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Bng2latlongConverterResponse([]),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        [, $err] = Bng2latlongConverterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec([]),
            'response' => null,
            'result' => new Bng2latlongConverterResult([]),
        ]);
        [, $err] = Bng2latlongConverterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec(['step' => 's']),
            'response' => new Bng2latlongConverterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        [, $err] = Bng2latlongConverterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec(['step' => 's']),
            'response' => new Bng2latlongConverterResponse(self::resp(200, ['v' => 1])),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        [, $err] = Bng2latlongConverterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec(['step' => 's']),
            'response' => new Bng2latlongConverterResponse(self::resp(200, ['v' => 2])),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Bng2latlongConverterMakeResponse::call($ctx);
    ...
    {
        $preset = new Bng2latlongConverterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec([]),
            'response' => new Bng2latlongConverterResponse([]),
            'result' => new Bng2latlongConverterResult([]),
        ...
        [$got, $err] = Bng2latlongConverterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Bng2latlongConverterResult([])]);
        [, $err] = Bng2latlongConverterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Bng2latlongConverterSpec([]), 'result' => null]);
        [, $err] = Bng2latlongConverterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Bng2latlongConverterSpec(['step' => 's']),
            'result' => new Bng2latlongConverterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Bng2latlongConverterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Bng2latlongConverterSpec(['step' => 's']),
            'result' => new Bng2latlongConverterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Bng2latlongConverterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Bng2latlongConverterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Bng2latlongConverterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Bng2latlongConverterSpec([]),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Bng2latlongConverterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Bng2latlongConverterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Bng2latlongConverterError('boom', 'boom');
        $utility->fetcher = function (Bng2latlongConverterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Bng2latlongConverterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Bng2latlongConverterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Bng2latlongConverterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Bng2latlongConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Bng2latlongConverterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        Bng2latlongConverterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Bng2latlongConverterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Bng2latlongConverterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Bng2latlongConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Bng2latlongConverterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Bng2latlongConverterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Bng2latlongConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Bng2latlongConverterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Bng2latlongConverterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Bng2latlongConverterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Bng2latlongConverterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Bng2latlongConverterResult(['ok' => false])]);
        $this->expectException(Bng2latlongConverterError::class);
        Bng2latlongConverterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Bng2latlongConverterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Bng2latlongConverterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Bng2latlongConverterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Bng2latlongConverterBaseFeature();
        $b = new Bng2latlongConverterBaseFeature();
        Bng2latlongConverterFeatureAdd::call($ctx, $a);
        Bng2latlongConverterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Bng2latlongConverterBaseFeature
    {
        $f = new Bng2latlongConverterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Bng2latlongConverterFeatureAdd::call($ctx, self::named_feature('a'));
        Bng2latlongConverterFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        Bng2latlongConverterFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        Bng2latlongConverterFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        Bng2latlongConverterFeatureAdd::call($ctx, $replace);
        ...
        Bng2latlongConverterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Bng2latlongConverterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Bng2latlongConverterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Bng2latlongConverterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        Bng2latlongConverterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Bng2latlongConverterResponse(['headers' => null]),
            'result' => new Bng2latlongConverterResult([]),
        ]);
        Bng2latlongConverterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        Bng2latlongConverterResultBody::call($ctx);
