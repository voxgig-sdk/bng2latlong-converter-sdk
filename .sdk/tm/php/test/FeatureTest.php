...
// Bng2latlongConverter SDK feature test
//
...
class FtCtrl extends Bng2latlongConverterControl
{
...
class FtClient
{
    ...
    private Bng2latlongConverterUtility $utility;

    public function __construct(Bng2latlongConverterUtility $utility, array $options)
    {
    ...
    public function get_utility(): Bng2latlongConverterUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (Bng2latlongConverterContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public Bng2latlongConverterContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (Bng2latlongConverterContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = Bng2latlongConverterConfig::make_feature($name);
    ...
    private static function buildUrl(Bng2latlongConverterSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof Bng2latlongConverterError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new Bng2latlongConverterResponse($fetched);
        }
    ...
    private function fail(Bng2latlongConverterContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (Bng2latlongConverterContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
