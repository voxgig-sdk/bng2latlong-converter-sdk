...
// Bng2latlongConverter SDK audit feature
...
class Bng2latlongConverterAuditFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _emit(Bng2latlongConverterContext $ctx, string $outcome): void
    {
