...
// Bng2latlongConverter SDK ratelimit feature
...
class Bng2latlongConverterRatelimitFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _acquire(Bng2latlongConverterContext $ctx): void
    {
    ...
    private function _track(Bng2latlongConverterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
