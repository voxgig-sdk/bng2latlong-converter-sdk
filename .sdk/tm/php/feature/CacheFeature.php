...
// Bng2latlongConverter SDK cache feature
...
class Bng2latlongConverterCacheFeature extends Bng2latlongConverterBaseFeature
{
    ...
    private function _through(Bng2latlongConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
