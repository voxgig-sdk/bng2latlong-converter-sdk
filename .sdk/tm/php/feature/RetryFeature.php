...
// Bng2latlongConverter SDK retry feature
...
class Bng2latlongConverterRetryFeature extends Bng2latlongConverterBaseFeature
{
    ...
    public function init(Bng2latlongConverterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Bng2latlongConverterContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(Bng2latlongConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(Bng2latlongConverterContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
