...
// Bng2latlongConverter SDK utility type

class Bng2latlongConverterUtility
{
    ...
    public static function copy(Bng2latlongConverterUtility $src): Bng2latlongConverterUtility
    {
        $u = new Bng2latlongConverterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
