...
|---|---|---|
| `ts/` | @voxgig-sdk/bng2latlong-converter-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bng2latlong-converter-sdk \
      --repository voxgig-sdk/bng2latlong-converter-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bng2latlong-converter-sdk` shows it, and
`npm trust revoke @voxgig-sdk/bng2latlong-converter-sdk --id=<id>` removes it.
