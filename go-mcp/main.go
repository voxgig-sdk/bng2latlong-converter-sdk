// Command Bng2latlongConverter-mcp is an MCP server exposing the Bng2latlongConverter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Bng2latlongConverter_list  — list records of an entity
//	Bng2latlongConverter_load  — load a single record of an entity
//
