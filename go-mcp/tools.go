...
type Args struct {
	Entity string         `json:"entity" jsonschema:"coordinate_conversion"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Bng2latlongConverterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bng2latlong-converter_list",
		Description: "List records from Bng2latlongConverter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bng2latlong-converter_load",
		Description: "Load a single record from Bng2latlongConverter. " +
...
func runOp(client *sdk.Bng2latlongConverterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Bng2latlongConverterSDK, name string) (sdk.Bng2latlongConverterEntity, error) {
	switch strings.ToLower(name) {
	case "coordinate_conversion":
		return client.CoordinateConversion(nil), nil
