# Bng2latlongConverter SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # Bng2latlongConverterSDK.new, not Bng2latlongConverterSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    Bng2latlongConverterSDK.new(opts)
  end
