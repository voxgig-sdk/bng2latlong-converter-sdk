...
#      offline in seeded test mode (Bng2latlongConverterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Bng2latlongConverter_sdk.rb")
  SDK_CLASS = "Bng2latlongConverterSDK"
  ...
  SDK_BASE = "Bng2latlongConverter_sdk"
