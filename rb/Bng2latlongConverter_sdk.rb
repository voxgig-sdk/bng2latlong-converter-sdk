...
require_relative 'Bng2latlongConverter_types'
...
class Bng2latlongConverterSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = Bng2latlongConverterHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = Bng2latlongConverterHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, Bng2latlongConverterFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    Bng2latlongConverterUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = Bng2latlongConverterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = Bng2latlongConverterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = Bng2latlongConverterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => Bng2latlongConverterError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue Bng2latlongConverterError => err
    ...
    if fetched.is_a?(Hash)
      status = Bng2latlongConverterHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = Bng2latlongConverterError.new(
        "graphql_error", "Bng2latlongConverterSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = Bng2latlongConverterSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
