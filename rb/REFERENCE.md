# Bng2latlongConverter Ruby SDK Reference

Complete API reference for the Bng2latlongConverter Ruby SDK.
...
#### `Bng2latlongConverterSDK.test(testopts = nil, sdkopts = nil)`
