...
from bng2latlongconverter_sdk.utility import register

# Load features
from bng2latlongconverter_sdk.feature.base_feature import Bng2latlongConverterBaseFeature
from bng2latlongconverter_sdk.features import _has_feature, _make_feature
...
class Bng2latlongConverterSDK:
    ...
    def get_utility(self):
        return Bng2latlongConverterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Bng2latlongConverterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CoordinateConversion(self, data=None) -> "CoordinateConversionEntity":
        ...
        from bng2latlongconverter_sdk.entity.coordinate_conversion_entity import CoordinateConversionEntity
