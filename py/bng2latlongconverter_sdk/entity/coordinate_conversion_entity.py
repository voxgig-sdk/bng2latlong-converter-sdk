...
from bng2latlongconverter_sdk.bng2latlongconverter_types import (
...
class CoordinateConversionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CoordinateConversionEntity(self._client, opts)
    ...
    def data_get(self) -> CoordinateConversion:
    ...
    def match_get(self) -> CoordinateConversion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CoordinateConversion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CoordinateConversion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
