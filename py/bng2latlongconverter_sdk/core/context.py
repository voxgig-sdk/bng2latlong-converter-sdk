...
from bng2latlongconverter_sdk.core.control import Bng2latlongConverterControl
...
from bng2latlongconverter_sdk.core.helpers import get_ctx_prop, to_map
...
class Bng2latlongConverterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = Bng2latlongConverterControl()
        ...
        if isinstance(sp, Bng2latlongConverterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Bng2latlongConverterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Bng2latlongConverterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return Bng2latlongConverterOperation({})
    ...
    def make_error(self, code, msg):
        return Bng2latlongConverterError(code, msg, self)
