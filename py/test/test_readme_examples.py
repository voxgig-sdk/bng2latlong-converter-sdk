# Bng2latlongConverter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Bng2latlongConverterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Bng2latlongConverterSDK(...) and Bng2latlongConverterSDK.test(...) become
#      Bng2latlongConverterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bng2latlongconverter_sdk"
_SDK_CLASS = "Bng2latlongConverterSDK"
