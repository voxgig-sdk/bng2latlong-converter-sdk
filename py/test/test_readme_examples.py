# Bng2latlongConverter SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from bng2latlongconverter_sdk import Bng2latlongConverterSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"Bng2latlongConverterSDK": Bng2latlongConverterSDK, "os": os}
        try:
